...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        like = preferences.getInt(getString(R.string.like),
            0)
        dislike = preferences.getInt(getString(R.string.dislike),
            0)

        //Display default value of like and dislike
        textViewUp.text = like.toString()
        textViewDown.text = dislike.toString()
